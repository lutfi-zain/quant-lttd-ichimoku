...
- **[2026-06-20]** Cara penggunaan `agent-browser` yang paling tepat setelah berhasil menjalankan `agent-browser connect 9222` adalah dengan memanggil perintah secara langsung (misal: `agent-browser snapshot`) tanpa menambahkan argumen `--cdp` atau `--auto-connect`, karena daemon secara otomatis menargetkan tab aktif yang terhubung.
